<?php header('Content-type: image/svg+xml; charset=utf-8');
	...
	$arrCor = array("#191970","#00FF7F","#CD5C5C","#FF0000","#A020F0","#836FFF","#00F5FF","#FF7F00");
	//$rand_keys = array_rand($arrCor, 1);
...
<path id="XMLID_7_" fill="<?= $arrCor[$_GET["cor"]] ?>" d="M552.5,536.6l-41.3-14.9v-32.1v-72.7c-25.9-58.9,0-129,0-129v-95.6
